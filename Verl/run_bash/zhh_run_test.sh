...
export VERL_PROJECT_NAME='verl_grpo_example_gsm8k'
export VERL_EXPERIMENT_NAME='v071_qwen25_0_5b'
export VERL_FILE_LOGGER_ROOT=/home/ma-user/work/algorithm/lcc_verl_clone/log
export TENSORBOARD_DIR=/home/ma-user/work/algorithm/lcc_verl_clone/tensorboard/$VERL_PROJECT_NAME/$VERL_EXPERIMENT_NAME
